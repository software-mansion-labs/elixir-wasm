...
config :local_lv_kanban,
  ecto_repos: [LocalLvKanban.Repo],
...
config :local_lv_kanban, LocalLvKanbanWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: LocalLvKanbanWeb.ErrorHTML, json: LocalLvKanbanWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: LocalLvKanban.PubSub,
  live_view: [signing_salt: "s/ujXnr7"]
...
config :local_lv_kanban, LocalLvKanban.Mailer, adapter: Swoosh.Adapters.Local
